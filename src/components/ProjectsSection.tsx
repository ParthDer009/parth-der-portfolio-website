        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          {projects.map((project, i) => (
            <motion.div
              ...
              className="bg-card border border-border rounded-sm p-8 text-center relative overflow-hidden group hover:-translate-y-2 hover:scale-[1.02] hover:shadow-[0_0_40px_0px_hsl(var(--primary)/0.6),0_0_80px_-10px_hsl(var(--primary)/0.3)] hover:border-primary/60 transition-all duration-500"
            >
